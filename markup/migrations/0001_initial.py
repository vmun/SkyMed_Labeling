    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200, unique=True)),
                ('description', models.CharField(max_length=2000)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagePack', to='markup.Folder')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='image',
            name='imagePack',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='markup.ImagePack'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
        ...
        migrations.CreateModel(
            name='AllowedImagePack',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagePack', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='membership', to='markup.ImagePack')),
